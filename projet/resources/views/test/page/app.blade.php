...
<div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header"><span>fitness</span></h3>
            </div>
			...
			<li  class="active">
                ...
                <li class="dropdown">
					...
					<i class="material-icons">aspect_ratio</i>client</a></li>
                ...
                <li class="dropdown">
				 ...
				 <li class="dropdown">
                    <a href="{{ route('reservation.setting') }}"
					class="dropdown-toggle">
					<i class="material-icons">equalizer</i>
				
					
					<span>Abonnement client</span></a></li>
				...
				<li class="dropdown">
                    <a href="#"
					class="dropdown-toggle">
					<i class="material-icons">border_color</i><span>se déconnecter</span></a></li>
