...
Route::get('/reservation',[PostController::class,'reservation'])->name('reservation.setting');
Route::get('/recherche',[PostController::class,'recherche'])->name('recherche.setting');
