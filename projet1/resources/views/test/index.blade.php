...
@section('contenu')
    ...
    <div class="table-title">
      <div class="row">
        ...
        <form action="{{ route('client.setting') }}" method="GET" class="d-flex mt-5">
              <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="requette" style="width : 300px;">
